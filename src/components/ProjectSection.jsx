...
export const ProjectSection = () =>{
    return(
            <section id="projects" className="py-24 px-4 sm:px-8 lg:px-24 relative">
                <div className="container mx-auto max-w-5xl">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
                    Featured <span className="text-primary">Projects</span>
                    </h2>
                    <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
                    Here are some of my University projects. Each project was developed under the guidance of our lecturers.
                    </p>
                    ...
                    <a
                        ...
                        target="_blank"
                        href="https://github.com/shehanprabodya"
                    >
